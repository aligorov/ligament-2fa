...
работает без внешних хостов) и описание на странице входа. Применяется
**только при активной платной лицензии**: free/trial всегда видят
стандартный бренд Ligament. Ключ `branding`:
